...
temps2=temps=[0,10,70,110,145,160,185,200,232,243,275,300]
c3xtr=[]
for t in range(len(temps2)):
	c3xtr.append(simps(y=t_avg_ratmat[:t+1],x=temps2[:t+1]))

plt.figure()
plt.plot(temps,c3xtr,label='extarct')
plt.plot(c3s['t'],c3s['c33'])
